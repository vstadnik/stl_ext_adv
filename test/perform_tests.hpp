...
//      PerformanceTest::test_push_back ( sz_test , vector_test ) ;
//
namespace PerformanceTest
{
        ...
        )
    {
        ...
        test_bpt::fill_rand ( vec_szt , sz_test , 1 , 1 ) ;
        ...
        )
    {
        ...
        std::vector<size_t>     vec_szt ;
        test_bpt::fill_rand ( vec_szt , sz_test , n_dupl , 1 ) ;
    ...
    size_t  test_accumulate_fast ( const size_t  sz_test )
    {
        ...
        typedef container_bptree::sequence<_T, _AT, container_bptree::bp_tree_idx_acc>
                                _SEQCE_ACC ;
