...
namespace test_bpt
{
    ...
    {
        _CBT::sequence<_T, _AT,_CBT::bp_tree_array>               t_seqce ;
        _CBT::set     <_T, _Ls, _AT, _CBT::bp_tree_array>         t_set   ;
        _CBT::multiset<_T, _Ls, _AT, _CBT::bp_tree_array>         t_mset  ;
        _CBT::map     <_T, _T , _Ls, _AT2, _CBT::bp_tree_array>   t_map   ;
        _CBT::multimap<_T, _T , _Ls, _AT2, _CBT::bp_tree_array>   t_mmap  ;
