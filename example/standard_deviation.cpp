...
{
    using namespace container_bptree ;

    //  class ElementValues has been developed to demonstrate
    //  how to use fast algorithm bp_tree_idx_acc::accumulate(),
    ...
    typedef sequence<ElementValues,
                ...
                bp_tree_idx_acc>            SequenceElemValues ;
    ...
    void TestDeviation ( )
    {
        ...
        //  algorithms: std::accumulate() and bp_tree_idx_acc::accumulate()
        int                 sum_x_exact   = 0 ;
        int                 sum_x_2_exact = 0 ;
        int                 sum_x   = 0 ;
        int                 sum_x_2 = 0 ;
        ...
        //  and fast algorithm bp_tree_idx_acc::accumulate()
